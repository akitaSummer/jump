...
export default class FilterDropdown extends Component {
    ...
    this.setState(
      ...
      () => {
        ...
        if (
          ...
          let sub = this.state.subData[page_index].submenu[level1_index]
            .submenu[level2_index];
          if (this.props.updateMenuName) {
          ...
          shadowActiveMenuArr[page_index] = this.state.activeMenuArr[
            page_index
          ];
          this.setState(
            {
  ...
  selectFilterLabel = (page_index, box_index, label_index) => {
    let find_index = this.state.activeMenuArr[page_index][box_index].indexOf(
      label_index
    );
                            ...
                            <Fragment key={index}>
                              ...
                              >
                                <View className="menu-name">
                                  <Text> {sub.name} </Text>
                                  <Text className="iconfont icon-selected"></Text>
                                </View>
                              </View>
                            </Fragment>
                          );
                                                    ...
                                                    return (
                                                      ...
                                                      >
                                                        ...
                                                        sub_second.submenu
                                                          ...
                                                          >
                                                            更多
                                                            <Text className="iconfont icon-triangle"></Text>
                                                          </Text>
                                                        ) : null}
                                                      </Fragment>
                                                    );
